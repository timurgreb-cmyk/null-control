export default function AdminLoading() {
  return (
    <div className="p-8 max-w-5xl mx-auto min-h-[60vh] flex flex-col items-center justify-center">
      <div className="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col items-center text-center max-w-xs w-full animate-in fade-in duration-200">
        ...
        <p className="font-bold text-slate-900 text-sm">Загрузка панели управления...</p>
        <p className="text-[11px] text-slate-400 mt-1">Секунду, подгружаем актуальные данные</p>
      </div>
    </div>
  );
}
